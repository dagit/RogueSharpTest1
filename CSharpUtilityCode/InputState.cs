...
namespace InputUtil
{
   ...
   public class InputState
   {
      ...
      {
          PlayerIndex playerIndex;
          return IsKeyPressed(Keys.NumPad4, controllingPlayer, out playerIndex);
      }
      public bool IsScrollRight(PlayerIndex? controllingPlayer)
      {
          PlayerIndex playerIndex;
          return IsKeyPressed(Keys.NumPad6, controllingPlayer, out playerIndex);
      }
      public bool IsScrollUp(PlayerIndex? controllingPlayer)
      {
          PlayerIndex playerIndex;
          return IsKeyPressed(Keys.NumPad8, controllingPlayer, out playerIndex);
      }
      public bool IsScrollDown(PlayerIndex? controllingPlayer)
      {
          PlayerIndex playerIndex;
          return IsKeyPressed(Keys.NumPad2, controllingPlayer, out playerIndex);
      }
